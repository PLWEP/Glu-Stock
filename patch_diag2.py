...
section3 = [
    ...
    "            continue\n",
    "    print(f'\\U0001f4ca Pipeline Report: OK={ok_count} | Empty={skip_empty} | Short(<100)={skip_short} | Dropna(<50)={skip_dropna} | NaN={skip_mask} | Error={fail_err}')\n",
    "    if len(all_X) == 0:\n",
    "        print(f'\\u274c No valid data from {n_total} tickers!')\n",
    "        return None, None, feature_names\n",
    "    print(f'\\u2705 Aggregated {ok_count}/{n_total} tickers successfully.')\n",
...
print("00A SECTION 3 REWRITTEN WITH FULL STAGE COUNTERS!")
